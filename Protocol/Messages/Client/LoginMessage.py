    ...
    def process(self, db):
        ...
        if self.account_id == 0:
            ...
            if player_data:
                ...
                LoginFailedMessage(self.client, self.player, "Извините но ваша учетная запись не найдена.\nВозможно была очистка данных.\nПожалуста очистите данные приложение.").send()
